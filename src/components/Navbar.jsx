   ...
   return (
      <div className='flex justify-between items-center py-6 lg:py-0'>
         <div className='flex gap-2 items-center'>
            <h1 className='font-semibold text-2xl text-blue-400'>Dr. Ivo Pineda Somodevilla</h1>
         ...
         <div className='hidden lg:flex items-center'>
            ...
            <button className='text-center text-white border rounded-lg bg-blue-400 py-3 px-4'>Agendar Cita</button>
         </div>
