        ...
        <>
            <div className='flex flex-col sm:flex-row items-start gap-[35px] py-[70px]'>
                ...
                <SlideInFromLeft className='flex flex-col items-start gap-[35px] sm:order-1'>
                    <h2 className='font-semibold text-[35px] sm:text-[40px] md:text-[50px] lg:text-[60px]'>Dr. Ivo Pineda Somodevilla</h2>
                    ...
                    <button className='bg-blue-400 text-white text-[20px] px-4 py-2 rounded-lg'>Agendar Cita</button>
                </SlideInFromLeft>
            </div>
            {/* 
